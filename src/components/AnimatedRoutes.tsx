...
const FacultyProfileCompletion = lazy(() => import("@/pages/faculty/ProfileCompletion"));
  ...
  return (
    <Suspense fallback={<LoadingFallback />}>
      <Routes location={location} key={location.pathname}>
        ...
        <Route path="/admin-seed" element={<PageTransition><AdminSeed /></PageTransition>} />
        ...
        <Route path="/student/profile-complete" element={<PageTransition><StudentProfileCompletion /></PageTransition>} />
        ...
        <Route path="/faculty/profile-complete" element={<PageTransition><FacultyProfileCompletion /></PageTransition>} />
